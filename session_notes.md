...
**Итог:** 5 из 6 пунктов плана закрыты + 8 бэклог-пунктов (admins→БД,
...
pip-audit CI + offsite backup template) + bonus-fix `stop_active_timer`
+ GitHub push (`zerocious/Palph`). Pytest: **121 тест** (~14 сек).
