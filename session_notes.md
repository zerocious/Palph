...
**Итог:** 5 из 6 пунктов плана закрыты + 10 бэклог-пунктов (admins→БД,
...
bot.log → CSV для historical backfill) + bonus-fix `stop_active_timer`
+ GitHub push (`zerocious/Palph`). Pytest: **156 тестов** (~12 сек).
