...
> **Doc sync:** 2026-09-05 · **804** тест в 52 файлах, все зелёные
...
За время работы над документацией этот приём нашёл **12 непровальных
...
переименование делало сущность невидимой, и сравнение документа с числом,
...
| Документация | `test_docs_consistency.py` | 11 |
