...
> pytest suite **802** теста, все зелёные.
...
ключей локалей, счётчики контента, значения фичефлагов, счётчик тестов и
таблицу по областям в [testing.md](testing.md), все markdown-ссылки и
гигиену разметки. Если проверка упала — **правится документ, а не
проверка**.
