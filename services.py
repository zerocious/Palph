...
class LeaderboardService:
    ...
    # линейно и перестаёт влезать в лимит сообщения Telegram (4096 UTF-16
    # единиц): вкладка не открывалась совсем. Точный порог зависит от длины
    # @handle'ов (Telegram допускает 5–32 символа) — при коротких именах
    # замерено 219 друзей, при длинных ломается примерно вдвое раньше.
    # Режем так же, как лидерборд.
    #
