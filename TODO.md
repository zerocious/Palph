...
**Тесты:** 807 в suite, все зелёные. Требования к тестам —
...
**732 теста** в suite на момент закрытия фазы (сейчас в suite 807).
...
`test_pa_verify_export.py` 3) + **807 total** в suite.
