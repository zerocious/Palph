...
**Тесты:** 793 в suite, все зелёные. Требования к тестам —
...
**732 теста** в suite на момент закрытия фазы (сейчас в suite 793).
...
`test_pa_verify_export.py` 3) + **793 total** в suite.
