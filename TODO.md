...
**Тесты:** 804 в suite, все зелёные. Требования к тестам —
...
**732 теста** в suite на момент закрытия фазы (сейчас в suite 804).
...
`test_pa_verify_export.py` 3) + **804 total** в suite.
